...
class DetailFragment: Fragment(), GalleryListener {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        viewModel = ViewModelProviders.of(this, PersonViewModelFactory.INSTANCE).get(PersonDetailViewModel::class.java)

        val personId = DetailFragmentArgs.fromBundle(requireArguments()).personId
